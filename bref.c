...
#include <stdbool.h> 
    ...
    void vote_presedent(int N , int v)
    {
        ...
        char presedent[N][30]; // first arrys of presedent
        ...
        int index_new_arrays = 0; /// first index in the second arrays presedent
        char third_arrays_presedent[N][10]; ///// third arrays presedent
        ...
        void parte_vote_1()
            {
                ...
                for(int i = 0 ; i < v; i++)
                {
                    ...
                    index = vote[i]-1; /// stockage  vote every voteur in index and vote[i]-1 = pour starting value-1 IN THE ARRAYS
                    starting[index]++;          /// go to the index  and incrument the value of arrays starting in this index;
      ...
      /*  fin deletet part */
                    ...
                    for(int i = 0 ; i <N ; i++)
                    {
                     ...
                     ///// SHOW IF WE HAVE LESS THN 2 WINN
                    ...
                    if( test_egal == N-1 || TEST <= 2)  // N-1 == cuz test_egal he not arrive fin the N
                    {
                        //// her we repete the vote
        ...
        if( q > 1)
        {
            printf("\n\n this all presedent go to the third round : \n\n");
            for(int i = 0 ; i < q ;i++)
            {
        ...
        {
            printf("\n\nCongratulations the winn is  -----> %s" ,  third_arrays_presedent[0]);
        }
...
int main()
{
    ...
    while(N <5)
    {
        printf("sorry u should to add more thn 5 presedent : ? -->");
        scanf("%i" , &N);
    }
    ...
    while( v < 10)
    {
        printf("sorry u should to add more thn 10 voteur : ? -->");
        scanf("%i" , &v);
    }
